...
{
    uint8_t data[8];
    data[0] = (uint8_t)((int16_t)(euler_angles[0] * 10000)>>8);
    data[1] = (uint8_t)((int16_t)(euler_angles[0] * 10000));
    data[2] = (uint8_t)((int16_t)(euler_angles[1] * 10000)>>8);
    data[3] = (uint8_t)((int16_t)(euler_angles[1] * 10000));
    data[4] = (uint8_t)((int16_t)(euler_angles[2] * 10000)>>8);
    data[5] = (uint8_t)((int16_t)(euler_angles[2] * 10000));
    data[6] = 0;
    data[7] = 0;
    CAN_Send_Msg(&hcan1, data, 0x50, 8);
}
